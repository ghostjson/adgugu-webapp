<template>
    ...
    <section id="about" class="background-grey" style="padding-top: 100px;padding-bottom: 100px">
        <div class="container">
            <div class="row" style="display: flex; align-items: center; font-size: 2.5em;">
                <div class="col-lg-5">
                ...
                <div class="col-lg-6 offset-1 m-t-50">
                    <h2>Watch video on how ADGUGU works</h2>
                    <iframe src="https://www.youtube.com/embed/49Pp7RJfpA0" width="500" height="281" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
            </div>
